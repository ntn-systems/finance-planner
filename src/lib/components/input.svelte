<script lang="ts">
    ...
    const merged_classes = twMerge(
        'min-w-[198px] rounded-full px-3 py-1.5 font-sans',
        'border-violet-300 text-violet-900 dark:border-violet-500 dark:text-violet-50',
        'bg-violet-300 focus:ring-2 dark:bg-violet-600',
        'disabled:border-2 disabled:text-neutral-500 dark:focus:ring-violet-500',
