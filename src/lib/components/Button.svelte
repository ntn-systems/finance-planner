<script lang="ts">
    ...
    const classes = twMerge(
        'relative flex w-fit items-center justify-center  gap-2 rounded-full border-2 border-current bg-violet-50 px-3 py-2 text-center text-lg font-bold uppercase transition duration-200 ease-in dark:bg-violet-950',
